...
namespace SecurityEssentials.Unit.Tests.Core
{
    ...
    public class EmailTemplatesTests
    {
        ...
        private readonly string _applicationName = "Hep C";
        ...
        public void When_GetChangeEmailCompletedBodyText_Then_CorrectEmailIsReturned()
        {
            ...
            // Assert
            Assert.AreEqual(
                "Dear John Staveley,<br /><br />A request has been completed to change your Hep C username/email address from old@old.com to new@new.com. This email address can no longer be used to sign into the account. If you did not request this then please contact the website administration asap.<br /><br /><br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Hep C member\". Emails from Hep C will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_GetChangePasswordCompletedBodyText_Then_CorrectEmailIsReturned()
        {
            ...
            // Assert
            Assert.AreEqual(
                "Dear John Staveley,<br /><br />Just a note from Hep C to say your password has been changed today, if this wasn't done by yourself, please contact the site administrator asap<br /><br /><br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Hep C member\". Emails from Hep C will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_GetChangeSecurityInformationCompletedBodyText_Then_CorrectEmailIsReturned()
        {
            ...
            // Assert
            Assert.AreEqual(
                "Dear John Staveley,<br /><br />Please be advised that the security information on your Hep C account been changed. If you did not initiate this action then please contact the site administrator as soon as possible<br /><br /><br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Hep C member\". Emails from Hep C will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_GetPasswordResetBodyText_Then_NewPasswordIsReturned()
        {
            ...
            // Assert
            Assert.AreEqual(
                "Dear John Staveley,<br /><br />Just a note from Hep C to say your password has been changed to 'HRFJSHFERas12434' (without the quote marks), this action was done by a system administrator. From now on you won't be able to use your old password. If you don't like this new password, you can always change it when you logon.<br /><br /><br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Hep C member\". Emails from Hep C will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_RegistrationNeedsApprovalText_Then_CorrectEmailIsReturned()
        {
            ...
            // Assert
            Assert.That(emailText,
                Is.EqualTo(
                    "A user has requested access to Hep C. To approve or disallow access click on <a href='http://localhost:4986/User/Approvals'>http://localhost:4986/User/Approvals</a>"));
        }
    }
}