...
namespace SecurityEssentials.Unit.Tests.Controllers
{
    ...
    public class ValidateAntiForgeryTokenTest
    {
        ...
        public void AllHttpStateChangingControllerActionsShouldBeDecoratedWithValidateAntiForgeryTokenAttribute(
            Type action)
        {
            ...
            var failingActions = allControllerActions
                .Where(method => !((method.Name == "CspReporting" || method.Name == "HpkpReporting") &&
                                   method.DeclaringType.Name == "SecurityController"))
