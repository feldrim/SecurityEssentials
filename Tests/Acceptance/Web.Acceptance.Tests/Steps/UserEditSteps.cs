    ...
    public class UserEditSteps
    {
        ...
        public void ThenAConfirmationMessageIsShown(string message)
        {
            ...
            Assert.IsTrue(page.GetStatusMessage().Contains(message),
                $"A confirmation message '{message}' should have been displayed");
        }
        ...
        {
            var page = ScenarioContext.Current.GetPage<UserEditPage>();
            Assert.That(page.GetIfTextIndicatingUserIsAnAdminExists, Is.False,
                "The text indicating the user is an admin was  displayed and it shouldn't have");
        }
        ...
        {
            var page = ScenarioContext.Current.GetPage<UserEditPage>();
            Assert.That(page.GetIfTextIndicatingUserIsAnAdminExists, Is.True,
                "The text indicating the user is an admin was not displayed");
        }
