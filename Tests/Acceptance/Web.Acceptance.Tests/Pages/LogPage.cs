...
namespace SecurityEssentials.Acceptance.Tests.Pages
{
    public class LogPage : BasePage
    {
        ...
        private bool GridDisplayed => Driver.FindElements(By.Id("grid")).Count > 0 &&
                                      Driver.FindElements(By.Id("grid"))[0].Displayed;
        ...
        public List<Log> GetLogsDisplayed()
        {
            ...
            foreach (var dataRow in rowCollection)
            {
                ...
                if (columnCollection.Count > 0) data.Add(MapRow(columnCollection));
            }
