...
namespace SecurityEssentials.Core
{
    ...
    public class AppConfiguration : IAppConfiguration
    {
        public AppConfiguration()
        {
            ...
            DefaultCCEmailAddress = string.IsNullOrWhiteSpace(ConfigurationManager.AppSettings["DefaultCCEmailAddress"])
                ? null
                : ConfigurationManager.AppSettings["DefaultCCEmailAddress"];
            ...
            MaxNumberOfPreviousPasswords =
                Convert.ToInt32(ConfigurationManager.AppSettings["MaxNumberOfPreviousPasswords"]);
            PasswordExpiryStrategy =
                (PasswordExpiryStrategyKind) Convert.ToInt32(
                    ConfigurationManager.AppSettings["PasswordExpiryStrategy"]);
