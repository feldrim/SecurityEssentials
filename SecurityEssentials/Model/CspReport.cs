...
namespace SecurityEssentials.Model
{
    ...
    public class CspReport
    {
        ...
        /// <summary>
        ///     The URI of the resource that was blocked from loading by the Content Security Policy. If the blocked URI is from a
        ///     different origin than the document-uri, then the blocked URI is truncated to contain just the scheme, host, and
        ///     port.
        /// </summary>
